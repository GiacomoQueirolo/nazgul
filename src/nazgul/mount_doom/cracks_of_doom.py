...
class LensPartBasic(): 
    """
    Basis of the LensPart class, used as a canvas for the specific ones
    """
    def __init__(self,
                 Galaxy,
        ...
        raise RuntimeError("I am undecided if to do it this way")
        ...
        self.kwargs_source_model = {"cosmo":self.cosmo}
